...
tld_ex: tldextract.TLDExtract = tldextract.TLDExtract(include_psl_private_domains=True)
...
class UrlInfo(object):
    ...
    def full_domain(self) -> str:
        ...
        for https://www.google.com/ result will be www.google.com
    ...
    @property
    def url_filetype(self) -> Optional[str]:
        """
